...
@class SXAudioMeterObserver;

typedef void (^MLAudioMeterObserverActionBlock)(NSArray *levelMeterStates,SXAudioMeterObserver *meterObserver);
typedef void (^MLAudioMeterObserverErrorBlock)(NSError *error,SXAudioMeterObserver *meterObserver);
...
@interface SXAudioMeterObserver : NSObject
{
